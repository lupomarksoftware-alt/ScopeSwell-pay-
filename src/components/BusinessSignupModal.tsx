        ...
        <div className="p-5 sm:p-6 border-b border-slate-800 bg-gradient-to-r from-purple-950/50 via-slate-900 to-slate-900 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h2 id="business-modal-title" className="text-lg sm:text-xl font-bold text-white font-['Space_Grotesk'] leading-tight">
        ...
        <div className="overflow-y-auto flex-1 p-6 sm:p-7">
          {submittedBusiness ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label htmlFor="business-brand-name-input" className="block text-xs font-bold text-slate-300 mb-1.5">
                  Brand or Company Name *
                </label>
                <input
                  id="business-brand-name-input"
                  type="text"
              ...
              <div>
                <label htmlFor="business-contact-name-input" className="block text-xs font-bold text-slate-300 mb-1.5">
                  Contact Person *
                </label>
                <input
                  id="business-contact-name-input"
                  type="text"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label htmlFor="business-work-email-input" className="block text-xs font-bold text-slate-300 mb-1.5">
                  Work Email *
                </label>
                <input
                  id="business-work-email-input"
                  type="email"
              ...
              <div>
                <label htmlFor="business-website-input" className="block text-xs font-bold text-slate-300 mb-1.5">
            ...
            {/* Category */}
            <div>
              <label htmlFor="business-category-select" className="block text-xs font-bold text-slate-300 mb-1.5">
                Category
              </label>
              <select
              ...
              <div className="grid grid-cols-2 gap-2">
                {AD_FORMAT_OPTIONS.map((fmt) => (
                  ...
                  >
                    ...
                    {preferredAdFormats.includes(fmt) && (
                      <CheckCircle2 className="w-3.5 h-3.5 text-purple-400 shrink-0" aria-hidden="true" />
                    )}
                  </button>
                ))}
              </div>
            ...
            {!isGlobalOrNational && (
              <div className="grid grid-cols-2 gap-3 p-3.5 rounded-2xl bg-slate-950 border border-slate-800">
                <div>
                  <label htmlFor="business-target-city-input" className="block text-[11px] font-bold text-slate-300 mb-1">
                    Target City *
                  </label>
                  <input
                    id="business-target-city-input"
                    type="text"
                    value={city}
                ...
                <div>
                  <label htmlFor="business-neighborhood-input" className="block text-[11px] font-bold text-slate-300 mb-1">
                    Neighborhood / Radius
                  </label>
                  <input
                    id="business-neighborhood-input"
                    type="text"
                    value={neighborhood}
            ...
            {/* Campaign Objective */}
            <div>
              <label htmlFor="business-promotion-goal-input" className="block text-xs font-bold text-slate-300 mb-1.5">
                What are you promoting? (Offer / Link / Perk)
              </label>
              <textarea
                id="business-promotion-goal-input"
                rows={2}
