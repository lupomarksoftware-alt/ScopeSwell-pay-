          ...
          <div className="relative p-4 sm:p-5 rounded-2xl bg-slate-900/95 backdrop-blur-xl border border-slate-700/70 shadow-2xl shadow-black/60 text-slate-300">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0 pr-6">
                <h2 id="cookie-banner-title" className="text-xs font-bold text-white font-['Space_Grotesk'] tracking-wide">
                  Cookie & Privacy Preferences
                </h2>
                <p id="cookie-banner-desc" className="text-[11px] text-slate-300 mt-1 leading-relaxed">
                ...
                <div className="flex flex-wrap items-center gap-2 mt-3.5 pt-1">
                  <button
                    ...
                    className="px-4 py-2.5 sm:py-2 rounded-xl bg-gradient-to-r from-rose-500 to-purple-600 hover:from-rose-400 hover:to-purple-500 text-white font-bold text-xs shadow-md shadow-rose-950/40 transition-all flex items-center gap-1 cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="px-3.5 py-2.5 sm:py-2 rounded-xl bg-slate-800 hover:bg-slate-750 border border-slate-700 text-slate-300 hover:text-white text-xs font-semibold transition-all cursor-pointer"
                  >
                    Essential Only
                  </button>
                  ...
                  <button
                    ...
                    className="text-[11px] text-slate-400 hover:text-slate-200 underline transition-colors cursor-pointer p-2 sm:py-1"
                  >
              ...
              <button
                ...
                className="absolute top-3.5 right-3.5 p-2 sm:p-1.5 rounded-lg text-slate-400 hover:text-white hover:bg-slate-800/80 transition-colors cursor-pointer"
              >
